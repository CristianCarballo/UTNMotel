...
<html lang="en">
    <head>
        ...
        <title>UTN Motel - Listado Tipo Habitacion</title>
            ...
            <div id="page-content-wrapper">
                ...
                <center>
                    <div class="container-fluid">
                        ...
                        <h1 class="mt-4">
                            Listado Tipo Habitacion
                        </h1>
                        <c:choose>
                            <c:when test="${empty lista}">
                                <div class="alert alert-danger col-md-6" role="alert" >
                                    Lista de Tipos de Habitación Vacía
                                </div>
                            </c:when>
                            <c:otherwise>
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lista}" var="i">
                                            <tr>
                                                <th scope="row">${i.idTipoHabitacion}</th>
                                                <td>${i.descripcion}</td>
                                                <td>${i.capacidad}</td>
                                                <td>${i.precio}</td>
                                                <td><button type="button" class="btn btn-warning" onclick="window.location.href = '/UTNMotel/ServletRegistrarTipoHabitacion?id=${i.idTipoHabitacion}'">Editar</button></td>
                                                <td><button type="button" class="btn btn-danger"  onclick="window.location.href = '/UTNMotel/ServletEliminarTipoHabitacion?id=${i.idTipoHabitacion}'">Eliminar</button></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
