...
<html lang="en">
    <head>
        ...
        <title>UTN Motel - Listado Servicios</title>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lista}" var="i">
                                            <tr>
                                                <th scope="row">${i.idServicio}</th>
                                                <td>${i.descripcion}</td>
                                                <td>${i.precio}</td>
                                                <td><button type="button" class="btn btn-warning" onclick="window.location.href = '/UTNMotel/ServletRegistrarServicio?id=${i.idServicio}'">Editar</button></td>
                                                <td><button type="button" class="btn btn-danger"  onclick="window.location.href = '/UTNMotel/ServletEliminarServicio?id=${i.idServicio}'">Eliminar</button></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
