...
<html lang="en">
    <head>
        ...
        <title>UTN Motel - Registrar Tipo Habitacion</title>
    ...
    <body>
            ...
            <div id="page-content-wrapper">
                ...
                <center>
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="ServletRegistrarTipoHabitacion" onsubmit="return validar();">
                            <input type="text"
                                   name="txtId"
                                   hidden="" 
                                   value="${id}" 
                            ...
                            <input type="text" 
                                   ...
                                   pattern="[0-9]{1,20}" 
                                   title="Debe contener entre 1 y 20 caracteres, solo números"/>
                            <br>
        ...
        <script>
                            ...
                            function validar() {
                                var txtCapacidad = document.getElementById('txtCapacidad');
                                if (txtCapacidad.value === '') {
                                    alert('La Capacidad no debe estar vacia');
                                    return false;
                                }
