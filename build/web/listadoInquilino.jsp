...
<html lang="en">
    <head>
        ...
        <title>UTN Motel - Listado Inquilinos</title>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach items="${lista}" var="i">
                                            <tr>
                                                <th scope="row">${i.idInquilino}</th>
                                                <td>${i.nombre}</td>
                                                <td>${i.apellido}</td>
                                                <td>${i.dni}</td>
                                                <td>${i.domicilio}</td>
                                                <td>${i.telefono}</td>
                                                <td><button type="button" class="btn btn-warning" onclick="window.location.href = '/UTNMotel/ServletRegistrarInquilino?id=${i.idInquilino}'">Editar</button></td>
                                                <td><button type="button" class="btn btn-danger"  onclick="window.location.href = '/UTNMotel/ServletEliminarInquilino?id=${i.idInquilino}'">Eliminar</button></td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
